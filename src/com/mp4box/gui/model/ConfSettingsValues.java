...
public class ConfSettingsValues {
	...
	public static String MP4BOX_LINUX_PATH 		= "%PATH%";
	...
	public static String MP4BOX_OTHER_PATH 		= "%PATH%";
	...
	public static String HANDBRAKE_LINUX_PATH 		= "%PATH%";
	...
	public static String HANDBRAKE_OTHER_PATH 		= "%PATH%";
